...
以下为使用 Alpha Hunter 在 200 个交易日（2019年）上运行 6 代所挖掘出的部分有效因子（筛选条件：IC ≥ 0.04，ICIR ≥ 0.7）：
...
| mul(neg(X2), X2) | 0.0596 | 1.04 | 量比平方取反，等价于 neg(square(X2)) |

> **平均表现**：连续多代平均 IC 稳定在 0.052~0.054，平均 ICIR 保持在 0.82~0.85。
